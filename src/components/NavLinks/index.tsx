...
const NavLinks = ({ href, label }: LinksProps) => {
    ...
    return (
        <li className={`${pathname == href ? " bg-solar-orange-middle shadow-md" : "  shadow hover:shadow-md"} mx-2 border border-solar-gray-middle transition-opacity ease-in duration-400 opacity-100 hover:opacity-90 hover:bg-solar-orange-middle`}>
            <Link
